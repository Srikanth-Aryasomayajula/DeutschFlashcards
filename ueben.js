  ...
  flashcardTable.className = "flashcard-table";
	...
	function getBoldWords() {
	  return [
	    ...
	    "MV - Plural", "NS - Singular", "NS - Plural", "NS mit MV - Sin.", "NS mit MV - Pl.", "Präsens",
		...
		"Modalverben im Konjunktiv (Modalverb [finites Verb] + Infinitiv)", "Tenses in German", "German Tense", "English Tense", "Examples", "German Forms", "German Form",	"Usage", "Present Simple / Present Continuous", "Present Perfect (spoken past)", "Simple Past (written / formal)", "Past Perfect", "Future Simple", "Future Perfect", "Konjunktiv I", "Konjunktiv II", "Partizip I", "Partizip II" 
	  ];
	}
	...
	function getMergeConfigsGram() {
	  return [
	    ...
	    { text: ["Passivsätze"], matchPartial: false, direction: "row", span: 4, style: styleCenter() },
		...
		{ text: ["Tenses in German"], matchPartial: false, direction: "row", span: 3, style: styleCenter() },
		{ text: ["Note: Futur II is used mostly for assumptions (Vermutungen) about past: Er wird schon gegangen sein. (He has probably already left)"], matchPartial: false, direction: "row", span: 5, style: styleCenter() },
		{ text: ["German Forms"], matchPartial: false, direction: "row", span: 3, style: styleCenter() },
